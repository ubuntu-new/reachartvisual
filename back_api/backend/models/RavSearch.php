...
/**
 * RavSearch represents the model behind the search form of `backend\models\Rav`.
 */
class RavSearch extends Rav
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['fullname', 'description', 'site', 'facebook', 'instagramm', 'linkendin', 'metakeyword', 'status', 'top'], 'safe'],
        ];
    }
