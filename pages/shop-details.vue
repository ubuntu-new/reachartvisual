                ...
                <div class="col-md-12">
                    <div class="blog-details">
                        <div class="article-img">
                            <img :src="`https://art.webertela.online/backend/web/images/store/${shop.filePath}`" />
                        </div>
                    </div>
                </div>
            </div>
            <div class="row  mt-50">
                ...
                <div class="col-md-8">
                    <div class="article-content">
                        ...
                        <h3 class="text-center title-detail mb-85">{{ shop.title }}</h3>
                    </div>
                </div>
                <div class="col-md-2">&nbsp;</div>
            </div>
                ...
                <div class="col-md-12  mt-75 mb-75">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12 ">
                                <div class="blog-details" v-html="shop.description">
                                </div>
                                <span>
                                    {{ shop.facebook }}
                                </span>
...
export default {
  ...
  async created () {
	    let singleShop = this.$route.params.shop
        if(singleShop){
            this.shop = singleShop
        }
        else {
    ...
    mounted() {
        ...
        console.log('orderShop: ', this.singleShop);
    },
     methods:{
      myFunction: function () {   
          window.open( this.mus.facebook , "_blank");    
      },
    }
}
</script>
