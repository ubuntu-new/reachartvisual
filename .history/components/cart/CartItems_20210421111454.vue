                ...
                <div class="col-sm-12 col-md-3 backgroundGray">
                    <div class="cart-table table-responsive">
                        <table class="table table-bordered webertela">
                            ...
                            <tbody>
                                <tr>
                                    <td class="mt-40">Subtotal <span>${{cartTotal}}</span></td>
                                </tr>
                                <tr>
                                    <td class="mt-40">Shipping <span>$10.00</span></td>
                                </tr>
                                <tr>
                                    <td class="mt-40">Total <span><b>${{parseFloat(cartTotal + 10).toFixed(2)}}</b></span></td>
                                </tr>
