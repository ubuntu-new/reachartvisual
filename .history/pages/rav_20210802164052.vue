                    ...
                    <div class="faqiza">
                        ...
                        <v-hover v-slot="{ hover }">
                            ...
                            <v-card class="mx-auto" color="grey lighten-4" max-width="600">
                                <img :aspect-ratio="16/9" :src="`https://art.webertela.online/backend/web/images/store/${rav.filePath}`"  class="ravImage"/>
<!--                                
                                    <v-expand-transition>
...
export default {
    ...
    mounted() {
        ...
        axios.request({
                method: "post",
                url: "https://art.webertela.online/rest/web/index.php?r=v1/rav/list",
