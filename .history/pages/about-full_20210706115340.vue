...
<div class="container">
    <div class="row">
        <div class="col-12 mt-30" style="height: 100px;">
            <span class="about-us ">
               {{ about.title }}
            </span>
        </div>
    ...
    <div class="row ">
        <div class="col-12">
            <!-- {{ about.filePath }} -->
            <!-- <img  src="http://art.webertela.online/backend/web/images/store/" class="mx-auto d-block"> -->
            <img :src="`http://art.webertela.online/backend/web/images/store/${about.filePath}`" />
        </div>
    </div>
    ...
    data: () => ({
     ...
     mounted() {
        ...
        axios.request({
            method: "post",
            url:
            "http://art.webertela.online/rest/web/index.php?r=v1/about/list",
            headers: {
