...
<div class="ptb-60 augustBackground">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4" v-for="artists in allArtists" :key="artists">
                    ...
                    <div class="faqiza">
                        ...
                        <v-hover v-slot="{ hover }">
                            <v-card class="mx-auto" color="grey lighten-4" max-width="600">
                                <img :aspect-ratio="16/9" :src="`http://art.webertela.online/art_rest/backend/web/images/store/${artists.filePath}`"  class="artistsImage"/>
<!--                                
                                    <v-expand-transition>
                                ...
                                <v-card-text class="pt-6" style="position: relative;">
                                    <v-btn absolute color="orange" class="white--text" fab large right top>
                                     <router-link class="maxLink" :to="{ name: 'artists-details', params: { artists: artists }}">
                                                Explore more
                                            </router-link>
                                    </v-btn>
...
export default {
    ...
    mounted() {
        ...
        axios.request({
                method: "post",
                url: "http://art.webertela.online/art_rest/rest/web/index.php?r=v1/artists/list",
