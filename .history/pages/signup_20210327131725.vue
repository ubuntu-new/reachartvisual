...
<v-row justify="center">
    <v-col cols="12" sm="12" >
        <v-card ref="form" class="formiza">
            <span class='signupFormTitle'>Create an Account</span>
            <v-card-text>
                <v-text-field ref="name" v-model="name" :rules="[() => !!name || 'This field is required']" :error-messages="errorMessages" label="First name Last name"  required></v-text-field>
