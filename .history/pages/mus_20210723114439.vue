                    ...
                    <div class="faqiza">
                        ...
                        <v-hover v-slot="{ hover }">
                            ...
                            <v-card class="mx-auto" color="grey lighten-4" max-width="600">
                                <img :aspect-ratio="16/9" :src="`http://art.webertela.online/backend/web/images/store/${mus.filePath}`"  class="ravImage"/>
<!--                                
                                    <v-expand-transition>
...
export default {
    ...
    mounted() {
        ...
        axios.request({
                method: "post",
                url: "http://art.webertela.online/rest/web/index.php?r=v1/mus/list",
