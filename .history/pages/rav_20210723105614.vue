...
<div class="ptb-60 augustBackground">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4" v-for="rav in allRav" :key="rav">
                    ...
                    <div class="faqiza">
                        ...
                        <v-hover v-slot="{ hover }">
                            <v-card class="mx-auto" color="grey lighten-4" max-width="600">
                                <img :aspect-ratio="16/9" :src="`http://art.webertela.online/backend/web/images/store/${rav.filePath}`"  class="ravImage"/>
<!--                                
                                    <v-expand-transition>
                                ...
                                <v-card-text class="pt-6" style="position: relative;">
                                    <v-btn absolute color="orange" fab large right top>
                                     <router-link class="maxLink" :to="{ name: 'rav-details', params: { rav: rav }}">
                                                Explore more
                                            </router-link>
                                    </v-btn>
...
export default {
    ...
    mounted() {
        ...
        axios.request({
                method: "post",
                url: "http://art.webertela.online/rest/web/index.php?r=v1/rav/list",

                // data: bodyFormData,
            })
            .then((response) => {
                console.log('Products Response: ', response);
                this.allRav = response.data;
            });
    },
