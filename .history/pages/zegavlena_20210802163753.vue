                ...
                <template>
                    <div class="faqiza">
                        <v-card class="mx-auto" color="grey lighten-4" max-width="600">
                            <img :aspect-ratio="16/9" :src="`https://art.webertela.online/backend/web/images/journal/${journal.image}`" class="ravImage" />
                            <v-card-text class="pt-6" style="position: relative;">
                                <h3 class="text-h4 font-weight-light orange--text mb-2">
                                    {{ journal.title }}
                                </h3>
                                <a :href="journal.file" target="_blank">
                                    <h5>
                                        Go to the seller's page
                                    </h5>
                                </a>
                                <!-- <div class="font-weight-light text-h6 mb-2" v-html="journal.description" >
                                       {{ v-html }}
                                    </div> -->
                            </v-card-text>
                        </v-card>
...
export default {
    ...
    mounted() {
        ...
        axios.request({
                method: "post",
                url: "http://art.webertela.online/rest/web/index.php?r=v1/journal/list",
