...
<div>
    ...
    <section>
        <div class="container" style="margin-top:90px;">
            <div class="row">
                <div class="col-lg-5 mb-70">
                    <h1 class="blogtitle">
                        <nuxt-link to="/blog-one">Blog</nuxt-link>
                    </h1>
                </div>
            </div>
                    ...
                    <div class="mt-60">
                        ...
                        <ul class="list-inline justify-content-center">
                            ...
                            <li class="list-inline-item" style="position: relative; bottom:20px;">
                                <router-link :to="{ name: 'blog-details', params: { news: featured }}">
                                    Explore more
                                </router-link>
                            </li>
                        </ul>
                ...
                <div class="col-lg-4 col-md-6" v-for="news in allNews" :key="news.id">
                    <div class="single-news-post">
                        ...
                        <div class="news-content text-center">
                            ...
                            <div>
                                <ul class="list-inline justify-content-center">
                                    <li class="list-inline-item readMore">&nbsp;</li>
                                    <router-link :to="{ name: 'blog-details', params: { news: news }}">
                                        Explore more
                                    </router-link>
                                </ul>
                            </div>
