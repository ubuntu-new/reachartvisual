...
<form>
    ...
    <v-text-field v-model="email" :error-messages="emailErrors" label="E-mail" :maxLength="10" required @input="$v.email.$touch()" @blur="$v.email.$touch()"></v-text-field>
    <v-text-field v-model="phone" :error-messages="fullNameErrors"  label="Phone" required @input="$v.phone.$touch()" @blur="$v.phone.$touch()"></v-text-field>
