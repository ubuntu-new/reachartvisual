                ...
                <template>
                    <div class="faqiza">
                            ...
                            <v-card class="mx-auto" color="grey lighten-4" max-width="600">
                                <img :aspect-ratio="16/9" :src="`https://art.webertela.online/backend/web/images/store/${shop.filePath}`" class="ravImage" />
...
export default {
    ...
    mounted() {
        ...
        axios.request({
                method: "post",
                url: "https://art.webertela.online/rest/web/index.php?r=v1/shop/list",
