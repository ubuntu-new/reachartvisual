...
<div class="ptb-60 augustBackground">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4" v-for="shop in allShop" :key="shop">
                ...
                <template>
                    <div class="faqiza">
                        ...
                        <v-hover v-slot="{ hover }">
                            <router-link :to="{ name: 'https://www.amazon.com/Purple-Plum-Decor-Canvas-Pictures/dp/B00A1SAAF6/ref=sr_1_21?crid=228FR1H5CKQZR&dchild=1&keywords=artwork&qid=1627106746&sprefix=artwo%2Caps%2C343&sr=8-21'}" target="_blank">
                            <!-- <router-link class="maxLink" :to="{ name: 'shop-details', params: { shop: shop }}"> -->
                            <v-card class="mx-auto" color="grey lighten-4" max-width="600">
                                <img :aspect-ratio="16/9" :src="`http://art.webertela.online/backend/web/images/store/${shop.filePath}`"  class="ravImage"/>
<!--                                
                                    <v-expand-transition>
...
export default {
    ...
    mounted() {
        ...
        axios.request({
                method: "post",
                url: "http://art.webertela.online/rest/web/index.php?r=v1/shop/list",
