        ...
        <div class="container" style="margin-top:90px;">
            ...
            <div class="row" v-for="featured in featuredNews" :key="featured.id">
                <div class="col-lg-4 col-md-6">
                    <img :src="`http://art.webertela.online/backend/web/images/store/${featured.filePath}`" />
                </div>
                ...
                <div class="col-lg-4 col-md-6" v-for="news in allNews" :key="news.id">
                    <div class="single-news-post">
                        <div class="news-image">
                            ...
                            <img :src="`https://art.webertela.online/backend/web/images/store/${news.filePath}`" />
                            <!-- </nuxt-link> -->
                        </div>
...
export default {
    ...
    mounted() {
        ...
        axios.request({
            method: "post",
            url:
            "https://art.webertela.online/rest/web/index.php?r=v1/news/list",
            headers: {
