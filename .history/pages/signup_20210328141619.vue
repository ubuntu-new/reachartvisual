...
<form>
    ...
    <v-text-field v-model="password" type="password" :error-messages="passwordErrors" label="Password" :minLength="6"   required @input="$v.password.$touch()" @blur="$v.password.$touch()"></v-text-field>
