<template>
  <div class="main">
    <Banner></Banner>
    <v-divider class="mobiluriza"></v-divider>
    <AboutMain></AboutMain>
    <News></News>
    <Locations></Locations>
...
import AboutMain from '../components/landing-one/AboutMain';
import AboutMain from '../pages/about-full';
...
import Locations from '~/components/landing-one/Locations.vue';

export default {
  components: {
    Banner, AboutMain, Offer, LatestProducts, ProductCategory, TrendingProducts,
    BestSellers, Facility, Testimonials, News, Subscribe, Partner, InstagramPhotos, Locations, aboutFull
  }
}
</script>
