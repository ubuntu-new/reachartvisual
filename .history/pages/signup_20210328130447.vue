...
<form>
    ...
    <v-password-field v-model="password1" :error-messages="passwordErrors" label="Repeat Password"  required @input="$v.password1.$touch()" @blur="$v.password1.$touch()"></v-password-field>
