...
<form>
    ...
    <v-text-field v-model="phone" :error-messages="phoneErrors" label="Phone" minLength="6"  required @input="$v.phone.$touch()" @blur="$v.phone.$touch()"></v-text-field>
    <v-text-field v-model="password" type="password" :error-messages="passwordErrors" label="Password"  required @input="$v.password.$touch()" @blur="$v.password.$touch()"></v-text-field>
    <v-text-field v-model="password1" type="password" :error-messages="password1Errors" label="Confirm Password"  required @input="$v.password1.$touch()" @blur="$v.password1.$touch()"></v-text-field>
    <!-- <v-text-field label="Password*" v-model="password" type="password" required   :rules="[v => !!v || 'field is required']"></v-text-field> -->
    <!-- <v-text-field label="Confirm Password*" v-model="password1" type="password"  required   :rules="[(password === password1) || 'Password must match']"></v-text-field> -->
  ...
  export default {
    ...
    computed: {
      ...
      password1Errors () {
        ...
        !this.$v-sameAsPassword && errors.push('Passwords did not mach')
        return errors
      },
      emailErrors () {
        const errors = []
