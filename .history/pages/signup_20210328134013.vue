...
<form>
    ...
    <v-text-field v-model="password1" type="password" :error-messages="password1Errors" label="Confirm Password"  required @input="$v.password.$touch()" @blur="$v.password.$touch()"></v-text-field>
